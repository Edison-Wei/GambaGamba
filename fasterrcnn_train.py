...
### This was the initial approach of the system working.
#     Problem came when training the Faster RCNN on the combined
#     dataset of the Simulated and Real playing cards.
